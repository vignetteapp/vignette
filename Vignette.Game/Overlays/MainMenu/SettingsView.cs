...
{
    public abstract class SettingsView : MenuView
    {
        protected override Container<Drawable> Content => sectionFlow;

        private readonly SearchContainer sectionFlow;
        private readonly FluentScrollContainer scrollContainer;
        private readonly SettingsNavigation navigation;
        private readonly FluentSearchBox searchBox;
