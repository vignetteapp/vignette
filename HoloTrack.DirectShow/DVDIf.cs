...
namespace HoloTrack.DirectShow.Dvd
{
    #region Declarations
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst=8)] public DvdMUAMixingInfo[] Info;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst=8)] public DvdMUACoeff[] Coeff;
    }
    ...
    public class DvdTitleAttributes
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst=8)] public DvdAudioAttributes[] AudioAttributes;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst=8)] public DvdMultichannelAudioAttributes[] MultichannelAudioAttributes;
        public int ulNumberOfSubpictureStreams;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst=32)] public DvdSubpictureAttributes[] SubpictureAttributes;
    }
