...
namespace HoloTrack.DirectShow
{
    ...
    public interface IVMRDeinterlaceControl9
    {
        ...
        int GetNumberOfDeinterlaceModes(
            ...
            [Out, MarshalAs(UnmanagedType.LPArray)] Guid[] lpDeinterlaceModes
            );
    ...
    public interface IVMRImageCompositor9
    {
        ...
        int CompositeImage(
            ...
            [In] long rtEnd,
            [In] int dwClrBkGnd,
            [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex=7)] VMR9VideoStreamInfo[] pVideoStreamInfo,
            [In] int cStreams
            );
    }
    ...
    public interface IVMRMonitorConfig9
    {
        ...
        int GetAvailableMonitors(
            [Out, MarshalAs(UnmanagedType.LPArray)] VMR9MonitorInfo[] pInfo,
